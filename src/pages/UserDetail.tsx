    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-3 md:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-6">
          {/* Banner Background */}
          <div className="h-24 md:h-32 bg-gradient-to-r from-primary via-accent to-primary bg-[length:200%_100%] animate-gradient"></div>

          <div className="px-4 md:px-6 pb-4 md:pb-6">
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 -mt-12 md:-mt-16">
              <div className="flex flex-col sm:flex-row items-start sm:items-end gap-4">
                {/* Avatar */}
                <div className="shrink-0 w-24 h-24 md:w-32 md:h-32 rounded-2xl bg-gradient-to-br from-primary to-accent flex items-center justify-center text-gray-900 font-bold text-4xl md:text-5xl border-4 border-white shadow-xl">
                  {user.firstName?.[0]}
                  {user.lastName?.[0]}
                </div>
              ...
              <div className="flex gap-3 sm:self-end">
                <button
                  onClick={() => navigate("/users")}
                  className="px-4 py-2.5 border-2 border-gray-300 rounded-lg text-gray-700 font-semibold hover:bg-gray-50 hover:border-gray-400 hover:shadow-md transition-all flex items-center gap-2"
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
                ...
                <button className="px-4 py-2.5 bg-gradient-to-r from-primary to-accent text-white rounded-lg font-semibold hover:shadow-lg hover:scale-[1.02] transition-all flex items-center gap-2">
                  <svg
                    className="w-4 h-4"
                    fill="none"
                    stroke="currentColor"
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-6">
              ...
              <div className="text-center mb-4">
                <div className="inline-flex items-center justify-center w-24 h-24 rounded-full bg-gradient-to-br from-primary to-accent text-gray-900 mb-3">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-6">
              ...
              <div className="space-y-3">
                ...
                <button className="w-full flex items-center gap-3 p-3 rounded-lg border-2 border-gray-200 hover:border-primary hover:bg-gray-50 transition-all group">
                ...
                <button className="w-full flex items-center gap-3 p-3 rounded-lg border-2 border-red-200 hover:border-red-400 hover:bg-red-50 transition-all group text-red-600">
